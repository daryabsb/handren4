<template>
    <q-page class="q-pa-md ml-16">
        <card-social icon_position="right" />


        <q-card class="q-mt-sm no-shadow bg-none">
            ...
            <div class="flex w-full">
                <q-card-section class="q-pa-none q-ma-none pr-4 w-2/3">
                    <q-table class="border no-shadow" :rows="sales_data" :columns="sales_column" hide-bottom>
                ...
                <q-card-section class="q-pa-none q-ma-none w-1/3">
                                            ...
                                            <q-item-section side>
                                                <div class="text-grey-8 q-gutter-xs">
                                                    <q-btn class="gt-xs" size="md" flat color="blue" dense round
                                                        icon="comment" />
                                                    <q-btn class="gt-xs" size="md" flat color="red" dense round
                                                        icon="email" />
        ...
        <q-card class="q-mt-sm no-shadow" bordered>
            <q-card-section class="row">
                <div class="col-lg-7 col-sm-12 col-xs-12 col-md-7">
                    ...
                    <div>
                        <ECharts :option="sales_options" class="q-mt-md" :resizable="true" autoresize
                            style="height: 200px;" />
                    </div>
                </div>
                <div class="col-lg-5 col-sm-12 col-xs-12 col-md-5">
                    ...
                    <div>
                        <ECharts :option="pie_options" class="q-mt-sm" :resizable="true" autoresize
                            style="height: 200px;" />
                    </div>
                </div>
            </q-card-section>
