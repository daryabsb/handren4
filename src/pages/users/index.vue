        ...
        <div class="flex-grow overflow-hidden flex flex-col relative bg-gray-100 dark:bg-gray-900">
            ...
            <div class="flex-grow flex overflow-hidden">
                ...
                <div
                    ...
                    <div v-else class=" max-h-[66vh] overflow-y-auto px-1  pb-16">
                        ...
                        <div v-else class="h-full w-full flex justify-center items-center">
                            <q-circular-progress indeterminate size="75px" :thickness="0.6" color="lime"
                ...
                <div class="h-full flex-grow bg-white dark:bg-gray-900">
                    <div
                        class="sm:px-7  px-4  flex flex-col w-full border-b border-gray-200 bg-white dark:bg-gray-900 dark:text-white dark:border-gray-800 sticky top-0">
