                    ...
                    <div v-else class=" max-h-[66vh] overflow-y-auto px-1  pb-16">
                        <div v-if="filteredClients" class="space-y-2 mt-3">
                            <q-list bordered>
                                ...
                                <q-item v-for="client in filteredClients" :key="client.id" draggable="true"
                                    @dragstart="onDragStart($event, client)" :active="selectedClient === client.id"
                                    clickable v-ripple active-class="bg-pink-200" @click="selectClient(client.id)"
                                        ...
                                        <tr>
                                            <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                                                <div class="flex items-center">
                                                    <svg viewBox="0 0 24 24" class="w-4 mr-5 text-yellow-500"
