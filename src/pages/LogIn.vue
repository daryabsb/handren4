          ...
          <q-card square class="shadow-24" style="width:400px;height:540px;">
            ...
            <q-card-section>
              ...
              <q-form class="q-px-sm q-pt-xl">
                ...
                <q-input ref="passwordField" square clearable v-model="password" :type="passwordFieldType" lazy-rules
                  :rules="[required, short]" label="
Password">
                ...
                <q-input ref="repasswordField" v-if="register" square clearable v-model="repassword"
                  :type="passwordFieldType" lazy-rules :rules="[required, short, diffPassword]" label="Repeat password">
                  <template v-slot:prepend>
                    <q-icon name="lock" />
                  </template>
                  <template v-slot:append>
